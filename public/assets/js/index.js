$(function(){
    ...
    var chart = c3.generate({
        bindto: '#chart-OrganicVisits', // id of chart wrapper
        data: {
            columns: [
                // each columns data
                ['data1', 110, 81, 158, 108, 149, 217, 133, 100, 102, 201, 167, 129],
                ['data2', 70, 192, 75, 97, 178, 152, 23, 76, 39, 72, 88, 40]
            ],
    ...
    var spark3 = new ApexCharts(document.querySelector("#apexspark4"), spark3);
    spark3.render();
