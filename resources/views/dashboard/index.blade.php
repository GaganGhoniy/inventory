        ...
        {{-- <div class="col-lg-8 col-md-12 col-sm-12 text-lg-right">
            <div
                ...
                <div class="border-right pr-4 mr-4 mb-2 mb-xl-0">
                    <p class="text-muted mb-1">Today’s profit <span id="mini-bar-chart2" class="mini-bar-chart"></span>
                    </p>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light page_menu">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav mr-auto">
                    <li class="{{ Request::segment(2) === 'index' ? 'nav-item active' : null }}"><a class="nav-link"
                            href="{{route('dashboard.index')}}">Analytics</a></li>
                    <li class="{{ Request::segment(2) === 'cryptocurrency' ? 'nav-item active' : null }}"><a
                            class="nav-link" href="{{route('dashboard.cryptocurrency')}}">Cryptocurrency</a></li>
                    <li class="{{ Request::segment(2) === 'campaign' ? 'nav-item active' : null }}"><a class="nav-link"
                            href="{{route('dashboard.campaign')}}">Campaign</a></li>
                ...
                <div class="ml-auto">
                    <a href="{{route('apps.todolist')}}" class="btn btn-default">ToDo</a>
                ...
                <div class="btn-group mb-3">
                    <div class="btn-group" role="group">
                        <button id="btnGroupDrop1" type="button" class="btn btn-default dropdown-toggle"
                            data-toggle="dropdown">14 March 2020</button>
                        <div class="dropdown-menu">
    ...
    <div class="col-lg-8 col-md-12">
        <div class="card">
            <div class="header">
                ...
                <small class="text-muted font-12">It is the period time a user is actively engaged with your website,
                    page or app, etc</small>
                ...
                <table class="table table-striped mb-0">
                    <tbody>
                        <tr>
                            ...
                            <td class="text-right"><span class="text-success">(0.25%) <i
                                        class="fa fa-caret-up"></i></span></td>
                        </tr>
                        <tr>
                            <td>Google</td>
                            <td class="text-right">956.3</td>
                            <td class="text-right"><span class="text-danger">(-0.15%) <i
                                        class="fa fa-caret-down"></i></span></td>
                        </tr>
                        <tr>
                            <td>DMKT</td>
                            <td class="text-right">89.74</td>
                            <td class="text-right"><span class="text-success">(0.85%) <i
                                        class="fa fa-caret-up"></i></span></td>
                        </tr>
                        <tr>
                            <td>Lenovo</td>
                        ...
                        <tr>
                            ...
                            <td class="text-right"><span class="text-success">(0.65%) <i
                                        class="fa fa-caret-up"></i></span></td>
                        </tr>
                        <tr>
                            <td>Dell</td>
                        ...
                        <tr>
                            ...
                            <td class="text-right"><span class="text-danger">(-0.42%) <i
                                        class="fa fa-caret-down"></i></span></td>
                        </tr>
                        <tr>
                            <td>TCS</td>
                            <td class="text-right">48.75</td>
                            <td class="text-right"><span class="text-danger">(-0.63%) <i
                                        class="fa fa-caret-down"></i></span></td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div class="card">
            ...
            <div class="body">
                ...
                <div class="avatar-list avatar-list-stacked mt-3">
                    <img class="avatar avatar-sm" src="{{ asset('assets/images/xs/avatar5.jpg') }}"
                        data-toggle="tooltip" title="" data-original-title="Avatar">
                    <img class="avatar avatar-sm" src="{{ asset('assets/images/xs/avatar6.jpg') }}"
                        data-toggle="tooltip" title="" data-original-title="Avatar">
                    <img class="avatar avatar-sm" src="{{ asset('assets/images/xs/avatar1.jpg') }}"
                        data-toggle="tooltip" title="" data-original-title="Avatar">
                    <img class="avatar avatar-sm" src="{{ asset('assets/images/xs/avatar4.jpg') }}"
                        data-toggle="tooltip" title="" data-original-title="Avatar">
                </div>
