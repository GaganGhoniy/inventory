<table style="margin: 0 auto; width: 700px;">
    <tr>
        ...
        <td>
            <h1 style="text-align: center; margin-top: 30px">PT. DAKONAN MAS <br> Laporan Barang Keluar</h1>
        </td>
        <td style="width: auto">
...
<table border="1" style="margin: 0 auto; width: 700px; font-size: 12px">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align: center; padding: 4px;">{{ $keluar->total_item }}</td>
            @hasanyrole('root admin|super admin|Kepala Divisi Gudang')
            <td style="text-align: center; padding: 4px;">@if ($keluar->persen != null) {{ $keluar->persen }}% @else 0% @endif</td>
            <td style="text-align: center; padding: 4px;">Rp. {{ number_format($keluar->harga,0,'','.') }}</td>
            <td style="text-align: center; padding: 4px;">Rp. {{ number_format($keluar->total_harga,0,'','.') }}
            </td>
            @endhasanyrole
        </tr>
        @endif
        ...
        <tr>
            ...
            <td style="text-align: center; padding: 4px;"><b>Rp. {{ number_format($sum_harga,0,'','.') }}</b></td>
            <td style="text-align: center; padding: 4px;"><b>Rp. {{ number_format($sum_total_harga,0,'','.') }}</b>
            </td>
            @endhasanyrole
        </tr>
        <?php
        ...
        <tr>
            ...
            @hasanyrole('root admin|super admin|Kepala Divisi Gudang')
            <td style="text-align: center; padding: 4px;"><b></b></td>
            <td style="text-align: center; padding: 4px;"><b>Rp. {{ number_format($tot_harga,0,'','.') }}</b></td>
            <td style="text-align: center; padding: 4px;"><b>Rp. {{ number_format($tot_total_harga,0,'','.') }}</b>
            </td>
            @endhasanyrole
        </tr>
    </tbody>
